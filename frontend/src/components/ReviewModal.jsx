    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 14, alignItems: "center", marginBottom: 20 }}>
          ...
          <div>
            <span style={{ fontSize: 11, fontWeight: 800, color: "#5E8C77", textTransform: "uppercase", letterSpacing: "1px" }}>
              Verified Purchase
            </span>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: "#5E8C77", marginLeft: 8 }}>
                {rating === 5
                  ? "5.0 — Excellent!"
                  : rating === 4
                  ? "4.0 — Very Good"
          ...
          <button
            ...
            style={{
              ...
              boxShadow: "0 4px 16px rgba(94, 140, 119, 0.3)",
