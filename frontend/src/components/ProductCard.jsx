    ...
    return (
        ...
        >
            ...
            <div className={`relative bg-[#F4EFE6] rounded-[18px] overflow-hidden shrink-0 w-full mb-3.5 border border-[#EFE8DF]/70 shadow-2xs ${compact ? "h-[170px]" : "aspect-square"}`}>
                ...
                <button
                    className="absolute top-3 right-3 z-10 w-8.5 h-8.5 rounded-full bg-white/90 backdrop-blur-xs shadow-2xs flex items-center justify-center cursor-pointer transition-all duration-200 hover:scale-110 active:scale-95 hover:bg-white"
                    onClick={handleWish}
