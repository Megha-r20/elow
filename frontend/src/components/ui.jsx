...
export const Icons = {
    ...
    Heart: ({ filled = false }) => (<svg width="18" height="18" viewBox="0 0 24 24" fill={filled ? "#E26D5C" : "none"} stroke={filled ? "#E26D5C" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
